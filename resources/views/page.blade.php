<div class="container-fluid">
    <div class="row">
        {{-- Flash сообщения для разных действий --}}
        @if (session('success'))
        ...
        @endif
        @if ($m == 'test')
            <div style="width: 100%; overflow-x: auto; background: #121212; padding: 20px; border-radius: 8px;">
                <!-- Основной корпус коммутатора -->
                <div
                    style="
        display: grid; 
    ...
    ">
                    ...
                    <!-- 1. Название и системные диоды -->
                    <div style="border-right: 1px solid #333; padding-right: 10px;">
                        <div style="font-size: 10px; color: #888; margin-bottom: 10px;">ENTERPRISE L3</div>
                        <div style="font-size: 9px; display: flex; flex-direction: column; gap: 4px;">
                            <div style="display: flex; align-items: center; gap: 5px;">
                                <div
                                    style="width: 6px; height: 6px; background: #28a745; border-radius: 50%; box-shadow: 0 0 5px #28a745;">
                                </div> PWR
                            </div>
                            <div style="display: flex; align-items: center; gap: 5px;">
                            ...
                            <div style="display: flex; align-items: center; gap: 5px;">
                                <div style="width: 6px; height: 6px; background: #444; border-radius: 50%;"></div> ALM
                            </div>
                        </div>
                    </div>

                    <!-- 2. Блок 24 RJ45 Портов -->
            ...
            ">
                            <!-- Генерируем 24 порта вручную, чтобы точно не развалилось -->
                            <!-- Четные сверху, нечетные снизу или наоборот - тут классическая шахматка -->
                            <style>
                                .sw-port {
                                    background: #333;
                            ...
                            <!-- Порты 1-12 (Верхний ряд) -->
                            <div class="sw-port">
                                <div class="sw-led"></div>
                                <div class="sw-num top-num">1</div>
                            </div>
                            <div class="sw-port">
                                <div class="sw-led"></div>
                                <div class="sw-num top-num">3</div>
                            </div>
                            <div class="sw-port">
                                <div class="sw-led"></div>
                                <div class="sw-num top-num">5</div>
                            </div>
                            <div class="sw-port">
                                <div class="sw-led" style="background:#444; box-shadow:none;"></div>
                                <div class="sw-num top-num">7</div>
                            </div>
                            <div class="sw-port">
                                <div class="sw-led"></div>
                                <div class="sw-num top-num">9</div>
                            </div>
                            <div class="sw-port">
                                <div class="sw-led"></div>
                                <div class="sw-num top-num">11</div>
                            </div>
                            <div class="sw-port">
                                <div class="sw-led"></div>
                                <div class="sw-num top-num">13</div>
                            </div>
                            <div class="sw-port">
                                <div class="sw-led"></div>
                                <div class="sw-num top-num">15</div>
                            </div>
                            <div class="sw-port">
                                <div class="sw-led"></div>
                                <div class="sw-num top-num">17</div>
                            </div>
                            <div class="sw-port">
                                <div class="sw-led"></div>
                                <div class="sw-num top-num">19</div>
                            </div>
                            <div class="sw-port">
                                <div class="sw-led"></div>
                                <div class="sw-num top-num">21</div>
                            </div>
                            <div class="sw-port">
                                <div class="sw-led"></div>
                                <div class="sw-num top-num">23</div>
                            </div>

                            <!-- Порты 13-24 (Нижний ряд) -->
                            <div class="sw-port">
                                <div class="sw-led"></div>
                            ...
                            <div class="sw-port">
                                <div class="sw-led" style="background:#444; box-shadow:none;"></div>
                                <div class="sw-num">8</div>
                            </div>
                            <div class="sw-port">
                                <div class="sw-led"></div>
                                <div class="sw-num">10</div>
                            </div>
                            <div class="sw-port">
                                <div class="sw-led"></div>
                                <div class="sw-num">12</div>
                            </div>
                            <div class="sw-port">
                                <div class="sw-led"></div>
                                <div class="sw-num">14</div>
                            </div>
                            <div class="sw-port">
                                <div class="sw-led"></div>
                                <div class="sw-num">16</div>
                            </div>
                            <div class="sw-port">
                                <div class="sw-led"></div>
                                <div class="sw-num">18</div>
                            </div>
                            <div class="sw-port">
                                <div class="sw-led"></div>
                                <div class="sw-num">20</div>
                            </div>
                            <div class="sw-port">
                                <div class="sw-led"></div>
                                <div class="sw-num">22</div>
                            </div>
                            <div class="sw-port">
                                <div class="sw-led"></div>
                                <div class="sw-num">24</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div style="border-left: 1px solid #333; padding-left: 20px;">
                        <div
                            style="display: grid; grid-template-columns: repeat(4, 40px); gap: 5px; background: #000; padding: 15px 10px; border: 1px solid #00cfda; border-radius: 4px;">
                            <div style="height: 25px; border: 1px solid #00cfda; background: #111; position: relative;">
                                <div
                                    style="font-size: 7px; color: #00cfda; position: absolute; bottom: -12px; width: 100%; text-align: center;">
                                    25</div>
                            </div>
                            <div style="height: 25px; border: 1px solid #00cfda; background: #111; position: relative;">
                                <div
                        ...
                        <div style="text-align: center; color: #00cfda; font-size: 10px; margin-top: 15px;">SFP /
                            Uplink</div>
                    </div>
...
@if ($mode == 'cbl')
    ...
    <div class="panel panel-default">
        ...
        <div id="addCBL" style="display:none;" class="panel-body">
            <form action="" method="GET">
                <input type="hidden" name="m" value="cbl">
                <input type="hidden" name="action" value="add_cbl">

                <div class="col-md-1">
                    <label>Магистрали\Внутрянка</label>
                    <select name="link_type" class="form-control" id="link_type_select">
                ...
                {{-- Сторона B --}}
                <div class="row" id="side_b_external_fields">
                    <div class="col-md-12">
                        <h4 style="color: #337ab7; border-bottom: 1px solid #eee; padding-bottom: 5px;">Сторона
                            B (Назначение)</h4>
                    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            //Функции формы добавления кабеля
            const linkTypeSelect = document.getElementById('link_type_select');
            const externalBox = document.getElementById('side_b_external_fields');

            linkTypeSelect.addEventListener('change', function() {
                if (this.value === 'internal') {
                    // Скрываем выбор оборудования и гео-координаты
            ...
            function setupCascade(parentSelector, childSelector, dataAttr) {
                ...
                parent.addEventListener('change', function() {
                    ...
                    childOptions.forEach(opt => {
                        if (opt.value === "" || opt.getAttribute(dataAttr) ==
                            selectedVal) {
...
<div class="col-md-12">
    ...
    @elseif($selected_location != 0 && $selected_rack == 0)
        ...
        <div class="panel panel-default">
            <div class="panel-heading" style="padding: 8px 15px;">
                <button type="button" class="btn btn-primary btn-sm" onclick="toggleForm('addRackForm')">Добавить
                    шкаф</button>
            </div>
                                ...
                                @if (!empty($rack['coordinates']))
                                    <div style="margin-bottom: 6px;">
                                        <a href="http://maps.yandex.ru/?text={{ urlencode($rack['coordinates']) }}"
                                            target="_blank" onclick="event.stopPropagation();" class="text-info"
    ...
    @elseif($selected_location != 0 && $selected_rack != 0 && $selected_panel == 0)
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <button type="button" class="btn btn-primary btn-sm" onclick="toggleForm('addPanelForm')">Добавить
                    оборудование</button>
                                    ...
                                    <div id="device-view-{{ $item['id'] }}-{{ $u }}"
                                        ...
                                        <div class="item-title">
                                            ...
                                            <a href="javascript:void(0)"
                                                ...
                                                title="Переместить устройство"><i class="fa fa-arrows"></i></a>
                                            <a href="javascript:void(0)"
                                        ...
                                        <form method="GET" action="{{ url('plugin/CablingJournal') }}">
                                            ...
                                            <div class="item-title">
                                                ...
                                                <a href="javascript:void(0)"
                                                    ...
                                                    class="text-muted pull-right" style="margin-left: 10px;"><i
                                                        class="fa fa-times"></i>
                                                    Отмена</a>
                                            </div>
...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <div class="panel panel-default">
            <div class="panel-heading" style="padding: 8px 15px;">
                <button type="button" class="btn btn-primary btn-sm" onclick="toggleForm('addCBL')">Подключить
                    Кабель</button>
            </div>
            <div id="addCBL" style="display:none;" class="panel-body">
                <form action="" method="GET">
                    <input type="hidden" name="m" value="in_panel">
                    <input type="hidden" name="action" value="add_cbl">
                    ...
                    <div class="col-md-1">
                        ...
                        <select name="link_type" class="form-control" id="link_type_select">
                            <option value="external">External (Внешний)</option>
                            <option value="internal" selected>Internal (Внутренний)</option>
                        </select>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <h4 style="color: #337ab7; border-bottom: 1px solid #eee; padding-bottom: 5px;">
                                Сторона
                                А (Источник)</h4>
                        </div>
                        ...
                        <tr>
                            ...
                            @if ($panel['type'] == 'fiber')
                                <td style="width: 100px;">
                                    <select name="fiber_color[{{ $port['id'] }}]" class="form-control input-sm">
